...
pub fn start_up() ->anyhow::Result<()>{
    ...
    shared::server::channel::set_sync_channel_handler(Box::new(move |session: Box<(dyn std::any::Any + std::marker::Send + std::marker::Sync + 'static)>|{
